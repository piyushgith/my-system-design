...
Select the correct architectural style for a real-time messaging platform, justify every major design decision, and provide full component diagrams, request flows, and an evolution path from MVP to Hyperscaler scale.

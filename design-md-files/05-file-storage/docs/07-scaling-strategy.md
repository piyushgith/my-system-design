...
- Total: 100 groups × 10 nodes = 1,000 ES nodes (only needed at 100B files — Hyperscaler scale).
...
| Hyperscaler | 500M DAU | Per-user ES shards, Citus/Vitess, 1,000+ ES nodes |

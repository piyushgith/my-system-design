CREATE UNIQUE INDEX idx_transactions_idempotency_key ON ledger.transactions (idempotency_key);
...
CREATE INDEX idx_liens_account_active ON accounts.liens (account_id);
CREATE INDEX idx_journal_account_value_date ON ledger.journal_entries (account_id, value_date);

...
## 9. Startup vs Hyperscaler Differences
...
**Hyperscaler/Scale approach:** Full double-entry ledger (essential when regulators audit), strong value objects (Money, CardToken), formal aggregate boundaries enforced by code structure, event sourcing for the ledger (advanced V3 evolution).

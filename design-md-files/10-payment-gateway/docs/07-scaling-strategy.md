...
| Hyperscaler | 100M+/day | 50,000 TPS | Multi-region active-active, sharded ledger |
...
**Phase 3 (Hyperscaler)**: Active-active multi-region
...
- **"How do you scale to 50K TPS?"** → Ledger partitioning + Redis for balance reads + Kafka for downstream decoupling + connection pooling; at true Hyperscaler scale, shard Postgres by account range
